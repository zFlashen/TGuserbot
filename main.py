...
GITHUB_RAW_URL = "https://github.com/zFlashen/TGuserbot/blob/main/main.py"  # Укажите URL вашего скрипта
...
@client.on(events.NewMessage(pattern="Чикс"))
async def chiks_figure(event):
    # Фигурка HELLO
    chiks_figure = """⣿⣿⣿⣿⣿⣿⣿⠋⣉⡙⠛⣉⣉⠻⣿⣿⣿⣿⣿⣿
⣿⣿⣿⣿⣿⣿⣿⠸⣿⣿⣾⣿⡿⠀⣿⣿⣿⣿⣿⣿
⣿⣿⣿⣿⣿⣿⣿⣦⡘⠻⣿⠟⣡⣾⣿⣿⣿⣿⣿⣿
...
"""
    ...
    await event.edit(chiks_figure) # Отправляем фигурку Chiks
...
⠄⡇⠄⠄⠄⠄⠄⢀⡤⠤⠶⠶⠾⠤⠄⢸⠄⡀⠸⣿⣀⠄⠄⠈⣇"""
    ...
    await event.edit(tyanka_figure)  # Отправляем фигурку сердца
...
┻┳┻┳┻┳┃┈▕╲▂╱┈╭╯"""
    ...
    await event.edit(etomi_figure)  # Отправляем фигурку сердца
...
💨💨💨💨💨💨💨💨
    ...
    for celuyu in celuyu_figure:
        ...
        await asyncio.sleep(1.1)  # Задержка в 0.3 секунды между кадрами
